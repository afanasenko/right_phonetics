...
-- ==============================================================================
(2, 1, 1, 1, 'Try to count', 'How many stresses does the word below have?', 'longword_count'),
(2, 1, 2, 3, 'Choose pattern', 'Group the words according to their stress pattern. Drag them to the right box.', 'longword_group'),
(2, 1, 3, 2, 'Tick', 'Tick the word which has a different stress pattern:', 'longword_odd'),
(2, 1, 4, 6, 'Try to mark', 'Mark the correct stress pattern in the word below:', 'longword_mark'),
--
(2, 2, 1, 8, 'Listen & Distinguish', 'Listen to the recording and choose the correct part of speach.', 'nounverb_choose'),
(2, 2, 2, 6, 'Mark the stress', 'Put stress signs in the right places.', 'nounverb_mark'),
--
...
-- ==============================================================================
(3, 1, 1, 1, 'Unstressed vowel', 'What vowel should be pronounced in the unstressed(underlined) syllable in the following words?', 'readsay_choose'),
(3, 1, 2, 1, 'Missing vowel', 'What vowel is missing in the transcription of the word provided that the word has only one stress?', 'readsay_missing'),
--
(3, 2, 1, 1, 'Listen', 'Listen to the audio file and choose the vowel pronounced in the underlined syllable.', 'readsay_listen'),
-- ==============================================================================
(5, 1, 1, 1, '', 'Choose the word where the palatalized allophone of the underlined consonant is pronounced.', 'palat_choose'),
(5, 1, 2, 4, '', 'Build a solid wall as high as possible. Each brick should have a word with a palatalized sound. The first step was done for you. You have 30 seconds.', 'palat_wall'),
(5, 2, 1, 1, '', 'Choose the word where the aspirated allophone of the underlined consonant is pronounced.', 'aspire_choose'),
(5, 2, 2, 6, '', 'Check all the cases where the sound in the next-to-checkbox position should be articulated with aspiration.', 'aspire_mark'),
(5, 2, 3, 4, '', 'Build a solid wall as high as possible. Each brick should have a word with an aspirated sound. The first step was done for you. You have 30 seconds.', 'aspire_wall'),
...
(2,1,1,'Long (three and more syllables) names (nouns and adjectives) of Romance origin have at least two stresses, the second being the primary stress.&lt;br/&gt;'),
(2,1,2,'Long (three and more syllables) verbs of Romance origin have two stresses. The secondary stress falls on suffix (&lt;nobr&gt;-ate&lt;/nobr&gt;, &lt;nobr&gt;-ise/-ize&lt;/nobr&gt;, &lt;nobr&gt;-fy&lt;/nobr&gt;), the primary stress - on the third syllable, being counted from the suffix forward to the beginning of the verb.'),
